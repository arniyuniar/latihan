...
}
{
    ...
    cout<<endl;
      {
        if (kelas==1)
        {
            cout<<"Kelas Kereta Dipilih        : Eksekutif"<<endl;
            cout<<"Harga Satuan Tiket        : Rp46000"<<endl;
        }
        else if (kelas==2)
        {
            cout<<"Kelas Yang Dipilih        : Bisnis"<<endl;
            cout<<"Harga Satuan Tiket        : Rp28000"<<endl;
        }
        else
        {
            cout<<"Kelas Yang Dipilih        : Ekonomi"<<endl;
            cout<<"Harga Satuan Tiket        : Rp18000"<<endl;
        }
        }
          cout<<"===================================================="<<endl;
        {
    ...
    cout<<"Alamat               : "<<alamat<<endl;
        ...
        {case 1:
         ...
         break;
        case 2:
         cout<<"Asal Stasiun            : Jakarta Kota"<<endl;
         break;
        case 3:
         cout<<"Asal Stasiun            : Malang"<<endl;
         break;
